...
class EditDeal extends Component {
  ...
  componentWillMount() {
    this.props.initialize(this.props.params.DealId);
  }
    ...
    if(state.status === 'pending' || state.status === 'error') {
      ...
      return (
        <div className="container-fluid">
          <div className="platform-button sticky-save" onClick={()=>{this.props.submitDealEdit(state.formData)}}>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    initialize: (DealId) => {
      dispatch(actions.initialize(DealId))
    },
    submitDealEdit: (formData) => {
      dispatch(actions.submitDealEdit(formData))
    },
    unMount: () => {
...
const EditDealContainer = connect(
  mapStateToProps, mapDispatchToProps
)(EditDeal)

export default EditDealContainer
